...
let
  ...
  agentInstructions = ''
    ...
    - For browser automation and web testing, prefer a capable harness-native browser tool; otherwise use `playwright-cli` and follow the available `.agents/skills/playwright-cli/SKILL.md` or `.claude/skills/playwright-cli/SKILL.md`. Use `playwright-cli show` for visual monitoring.
