...
- **laptop** (laptop): Framework 13 7040 AMD
- **workstation** (workstation): Gaming/desktop machine
...
│   │   ├── configuration.nix
│   │   └── home.nix
│   └── workstation/       # workstation host config
│       ├── configuration.nix
│       └── home.nix
...
- **Hostnames:** Lowercase (laptop, workstation)
...
- **Double quotes** for simple strings: `"laptop"`
